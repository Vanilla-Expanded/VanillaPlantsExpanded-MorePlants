...
{
    public class WorkGiver_GrowerHarvestFlowerGarden : WorkGiver_GrowerFlowerGarden
    {
        ...
        public override bool HasJobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            Zone_GrowingFlowerGarden zone_Growing = c.GetZone(pawn.Map) as Zone_GrowingFlowerGarden;
            if (zone_Growing != null && !zone_Growing.allowCut && plant.def != WorkGiver_GrowerFlowerGarden.wantedPlantDef)
            {
                return false;
            }
        ...
        public override Job JobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                ...
                if (!(intVec != c) || plant.def == WorkGiver_GrowerFlowerGarden.CalculateWantedPlantDef(intVec, map))
                {
