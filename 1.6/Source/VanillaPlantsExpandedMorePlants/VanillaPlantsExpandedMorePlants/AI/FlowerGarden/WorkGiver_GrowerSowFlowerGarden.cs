...
namespace VanillaPlantsExpandedMorePlants
{
	public class WorkGiver_GrowerSowFlowerGarden : WorkGiver_GrowerFlowerGarden
    {
		...
		public override Job JobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
		{
			...
			if (!WorkGiver_GrowerFlowerGarden.wantedPlantDef.CanNowPlantAt(c, map) || !PlantUtility.GrowthSeasonNow(c, map, wantedPlantDef) || !pawn.CanReserve(c, 1, -1, null, forced))
			{
				return null;
			}
